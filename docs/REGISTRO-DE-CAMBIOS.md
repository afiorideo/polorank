...
| POLO-2026-08-24-05 | 2026-08-24 | Configuración inicial de scraping | Configuración → Scraper: DataForSEO (credenciales de `Seo-Admin-Central`), estrategia `basic` (igual a SerpBear), refresco manual de prueba | Reversible desde la misma pantalla | pendiente |
